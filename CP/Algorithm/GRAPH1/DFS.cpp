...
problem 2: DFS cycle detection in undirected graph.
          (You can detect cycle Using Disjoint Set Union)
...
/*
	...
	white(-1) -> Node is not visited.
	black( 0)  -> Node is visited but present in Stack.
...
void solve() {
	...
	cout << "Distance from " << src1 << " to " << src2 << " is " << dis
		 << " which is maximum diameter of the tree" << endl;
}
